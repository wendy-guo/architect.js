...
// scenes
const scene_architectGrid = new Architect.Scene(gl_1, program_1, camera_1, [-1300, -280, 0], [70, 90, 0], [0.8, 0.8, 0.8]);  
...
const architectGrid = new Architect.BlocksGrid(11, 63, [55, 55, 55], [0, 0, 0], c1);
...
const grid2 = new Architect.BlocksGrid(18, 18, [20, 20, 20], [0, 0, 0], c2);
...
const grid4 = new Architect.BlocksGrid(18, 18, [20, 20, 20], [0, 0, 0], c2);
